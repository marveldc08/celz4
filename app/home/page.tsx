      ...
      <main className="flex flex-col items-center justify-center">
        ...
        <section className="w-full relative py-24 bg-[url('/images/about-bg.jpg')] bg-cover bg-center">
          ...
          <div className="relative z-20 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 md:grid-cols-3">
            ...
            <div className="h-full text-center md:text-left">
              <p className="mb-2 text-md  text-[#1E2F5C]">
                About Us
              </p>
            ...
            <div className="flex flex-col md:flex-row justify-between align-middle w-full">
              <div className="w-full md:w-[40%] m-2">
                ...
                <h1 className="text-xl font-semibold text-[#262626]">
                  Giving hope to the hopeless and helping them to fulfill God’s calling
                </h1>
              </div>
              <div className="w-full md:w-[40%] m-2">
                <p className="text-xs md:text-md text-[#525252]">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, facere eveniet quaerat voluptates quod sit magnam et earum explicabo numquam praesentium officia consequatur aut sint esse impedit odio. Modi, veritatis!
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-3 mt-10">
                <div className="md:pt-[30%]">
                    <div className="rounded-lg shadow-2xl">
                      <Image src="/images/outreach.png" alt="ministry image" width={200} height={200} className="mb-4 rounded-t-lg object-cover" style={{width:"100%"}}/>
                      <div className="p-3.5">
                        ...
                        <button className="inline-flex text-xs font-semibold text-[#1E2F5C]">
                          Learn More &nbsp; <span className="inline-flex h-4 w-4 items-center justify-center rounded-full border border-[#1E2F5C]">
                            <ChevronRight />
                          </span>
                        </button>
                ...
                <div className="md:pt-[60%]">
                  <div className="rounded-lg shadow-2xl">
                    <Image src="/images/children.png" alt="ministry image" width={200} height={200} className="mb-4 rounded-t-lg object-cover" style={{width:"100%"}}/>
                    <div className="p-3.5">
                      <h3 className="mb-2 text-md font-semibold text-[#1E2F5C]">
                        Children Ministry
                      </h3>
                ...
                <div className="md:pt-[90%]">
                  <div className="rounded-lg shadow-2xl">
                    <Image src="/images/media.png" alt="ministry image" width={200} height={200} className="mb-4 rounded-t-lg object-cover" style={{width:"100%"}}/>
                    <div className="p-3.5">
                      <h3 className="mb-2 text-md font-semibold text-[#1E2F5C]">
                        Media Ministry
                      </h3>
        ...
        <section className="w-full px-3 md:px-10 py-5 ">
            ...
            <div className="flex flex-col md:flex-row justify-evenly align-middle w-full">
              ...
              <div className=" flex flex-col justify-items-center align-middle w-full md:w-[40%] items-end-safe">
                 <button className="inline-flex text-sm font-semibold text-[#1E2F5C]">
                  View More &nbsp; <span className="inline-flex h-4 w-4 items-center justify-center rounded-full border border-[#1E2F5C]">
                    <ChevronRight />
                  </span>
                </button>
              </div>
                ...
                <div className=" flex flex-col justify-center align-middle my-2 px-10 md:px-40 ">
                    <div className="rounded-lg flex flex-col md:flex-row justify-center align-middle">
                      <div className="flex flex-row md:flex-col justify-items-center align-middle p-3.5 items-start-safe md:items-end-safe text-center">
                       ...
                       <Image src="/images/pastor.jpg" alt="ministry image" width={70} height={70} className="mb-4 rounded-lg object-cover w-5xl md:w-[20%]"/>
                      ...
                      <div className="p-1 m-0 flex flex-row md:flex-col justify-between align-middle">
                        <div>
                          ...
                          <p className="mb-3 text-sm leading-relaxed text-gray-700">
                            Uploaded by <span className="text-[#ab8134]" >Admin</span>
                          </p>
                        </div>
         ...
         <section className="w-full pb-24 px-20 mt-20">
            <div className="mx-auto max-w-7xl px-">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="md:row-span-2">
                  <Image src="/images/children.png" alt="Gallery image" width={70} height={70} className="mb-4 rounded-xl w-full h-full object-cover"/>
                </div>

                {/* Middle Top */}
                <div>
                <Image src="/images/pastor.jpg" alt="Gallery image" width={70} height={70} className="mb-4 rounded-xl w-full h-full object-cover"/>
                </div>

                {/* Right Top */}
                <div>
                  <Image src="/images/outreach.png" alt="Gallery image" width={70} height={70} className="mb-4 rounded-xl w-full h-full object-cover"/>
                </div>

                {/* Middle Bottom */}
                <div>
                <Image src="/images/media.png" alt="Gallery image" width={70} height={70} className="mb-4 rounded-xl w-full h-full object-cover"/>
                </div>
          ...
          <section className=" w-full relative flex justify-center align-middle p-20 md:px-40 md:py-30 bg-[url('/images/media.png')] bg-cover bg-center">
              <div className="absolute inset-0 bg-[#1E2F5C]/90 z-10" />
              <div className="relative z-20 border-2 border-white rounded-lg p-60">
                <div>
                  <p className="mb-3 text-sm leading-relaxed text-gray-700">
                    Join Us
                    </p>
                   <h3 className="mb-2 text-md text-wrap font-semibold text-[#525252]">
                    ...
                    <p className="mb-3 text-sm leading-relaxed text-gray-700">
                     Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus 
                    </p>
                  <button className="cursor-pointer rounded-full border-2 border-white p-4 md:p-8 text-md text-white">
                    Play
                  </button>
